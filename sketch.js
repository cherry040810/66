let points =[[1, 4], [1, 6], [2,7 ],[3,6],[2,4],[3,1],[2,0],[3,-2],[2,-3],[-1,-3],[-2,-2],[-1, 0], [-2, 1], [-1,4 ],[-2,6],[-1,7],[0,6],[0,4]]; //list資料，
var fill_colors ="ffd6ff-e7c6ff-c8b6ff-b8c0ff-bbd0ff".split("-").map(a=>"#"+a)
var line_colors ="d8e2dc-ffe5d9-ffcad4-f4acb7-9d8189".split("-").map(a=>"#"+a)
...
function preload(){
  elephant_sound = loadSound("sound/jump02.mp3")
  bullet_sound = loadSound("sound/shoot3.mp3")
