var monster_colors ="9a8f97-c3baba-e9e3e6-b2b2b2-736f72".split("-").map(a=>"#"+a)
...
class Monster{
    ...
    if(this.mode == "happy") {
      ...
      ellipse(this.r/2, 0, this.r/2);
      fill(0);
      ellipse(-this.r/4, 0, this.r/6);
      ellipse(this.r/4, 0, this.r/6);
    } else {
      fill(255);
      ellipse(0, -this.r/2, this.r/2);
      ellipse(0, this.r/2, this.r/2);
      fill(0);
      ellipse(0, -this.r/4, this.r/6);
      ellipse(0, this.r/4, this.r/6);
    }
        stroke(this.color)
        strokeWeight(4)
        ...
        for(var j=0;j<1;j++){
            ...
            beginShape()
               for(var i =0;i<(this.r/2);i++){
                  vertex(this.r/2+i,sin(i/4+frameCount/8)*20)
